...
from PyQt5.QtWidgets import QLabel, QLineEdit, QPushButton, QGridLayout, QDialog, QComboBox, QGroupBox
...
class SaveWindow(QDialog):
    def __init__(self, parent=None, file_name=None, MeasurementsLeft=None, MeasurementsRight=None,
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QtGui.QIcon(
            scriptDir + os.path.sep + 'include' + os.path.sep + 'icon_color' + os.path.sep + 'save_icon.ico'))
    ...
    def Save(self):
        ...
        MRD1 = np.array([[MeasurementsRight.MarginalReflexDistance1, MeasurementsLeft.MarginalReflexDistance1,
                          ...
                          MeasurementsPercentual.MarginalReflexDistance1]], dtype=object)
        ...
        MRD2 = np.array([[MeasurementsRight.MarginalReflexDistance2, MeasurementsLeft.MarginalReflexDistance2,
                          ...
                          MeasurementsPercentual.MarginalReflexDistance2]], dtype=object)
        # MRD2=np.array([[1,1,1,1]],dtype = object)
        PFH = np.array([[MeasurementsRight.PalpebralFissureHeight, MeasurementsLeft.PalpebralFissureHeight,
                         MeasurementsDeviation.PalpebralFissureHeight, MeasurementsPercentual.PalpebralFissureHeight]],
                       dtype=object)
        ...
        if self._NewFile:  # the user wants to create a new file
            ...
            size_list = [15, 20, 20, 20, 20, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18,
                         18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 20]
            ...
            if len(old_df.columns) is 45:
                ...
                # adjust the size of each column to fit the text
                size_list = [15, 20, 20, 20, 20, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10,
                             18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 10, 10, 18, 18, 20]
